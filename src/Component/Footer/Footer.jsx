...
import Third from '../../assets/Lookscout.png';
import Icon from '../../assets/Icon (3).png';
import { FaApple, FaFacebook, FaGoogle, FaInstagram } from 'react-icons/fa';

const Footer = () => {
  return (
    <div className=' w-full px-[16px] py-[32px] h-[600px]   md:py-[40px] md:px-[32px] lg:py-[64px] '>
    <div className='  flex  flex-col gap-[5px]  md:w-[full] md:gap-[48px] lg:gap-[4px] lg:flex-col justify-between lg:px-[32px] w-full lg:max-w-[1280px] lg:mx-auto lg:h-[100%]'>
        <div className=' w-full h-[200px] flex justify-between '>
            ...
            <div className=' flex flex-col w-full  gap-[16px] md:w-[247px] '>
                ...
                <img src={Third} className='h-full w-full' alt="" />
