...
const Check = () => {
    return (
        <div className=' w-full px-[16px] py-[32px]    md:py-[40px] md:px-[32px]  lg:py-[64px] '>
            <div className='  flex  flex-col gap-[52px]  md:w-[full] md:gap-[48px] lg:gap-0 lg:flex-row justify-between lg:px-[32px] w-full lg:max-w-[1280px] lg:mx-auto lg:h-[100%]'>
